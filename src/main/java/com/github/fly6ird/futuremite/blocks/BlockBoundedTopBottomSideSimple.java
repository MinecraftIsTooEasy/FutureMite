...
public class BlockBoundedTopBottomSideSimple extends BlockTopBottomSideSimple {
    ...
    public BlockBoundedTopBottomSideSimple(int id, Material material, String textureBase, float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
        super(id, material, textureBase);
        this.minX = minX;
        this.minY = minY;
        this.minZ = minZ;
        this.maxX = maxX;
