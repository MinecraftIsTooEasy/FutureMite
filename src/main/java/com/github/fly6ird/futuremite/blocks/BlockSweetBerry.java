...
import static com.github.fly6ird.futuremite.blocks.Blocks.stepSoundSweetBerryBush;
        ...
        if (stage >= 4 && stage != BlockSweetBerry.getMaxBerryGrowth()) {
            ...
            if (!world.isWorldClient()) {
                if (world.rand.nextFloat() < 0.15f)
                    world.setBlockMetadataWithNotify(x, y, z, BlockSweetBerry.setBerryStage(metadata, 7), 2);
