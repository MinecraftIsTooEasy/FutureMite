...
public class WorldGenBigCherryTree extends WorldGenerator {
    ...
    public WorldGenBigCherryTree(boolean par1) {
        super(par1);
    }
    ...
    void generateLeafNode(int par1, int par2, int par3) {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte) 1, Blocks.cherry.Leaves.blockID);
        }
    ...
    void generateTrunk() {
        ...
        this.placeBlockLine(var5, var6, Blocks.cherry.Log.blockID);
        if (this.trunkSize == 2) {
            int var10002 = var5[0]++;
            var10002 = var6[0]++;
            this.placeBlockLine(var5, var6, Blocks.cherry.Log.blockID);
    ...
    void generateLeafNodeBases() {
        ...
        for (int[] var3 = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1) {
            ...
            if (this.leafNodeNeedsBase(var6)) {
                this.placeBlockLine(var3, var5, Blocks.cherry.Log.blockID);
            }
        }
