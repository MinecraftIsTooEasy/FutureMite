...
public class WorldGenCherryForest extends WorldGenerator {
    public WorldGenCherryForest(boolean par1) {
        super(par1);
    }
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1) {
                    ...
                    for (var17 = par4 - 3 + var6; var17 <= par4 + var6; ++var17) {
                        ...
                        for (var11 = par3 - var10; var11 <= par3 + var10; ++var11) {
                            int var13 = var11 - par3;

                            for (int var14 = par5 - var10; var14 <= par5 + var10; ++var14) {
                                ...
                                if (Math.abs(var13) != var10 || Math.abs(var15) != var10 || par2Random.nextInt(2) != 0 && var9 != 0) {
                                    ...
                                    if (var16 == 0 || var16 == Block.leaves.blockID) {
                                        this.setBlockAndMetadata(par1World, var11, var17, var14, Blocks.cherry.Leaves.blockID, 2);
                                    }
                                }
                            }
                        }
                    ...
                    for (var17 = 0; var17 < var6; ++var17) {
                        ...
                        if (var9 == 0 || var9 == Block.leaves.blockID) {
                            this.setBlockAndMetadata(par1World, par3, par4 + var17, par5, Blocks.cherry.Log.blockID, 2);
                        }
                    }
