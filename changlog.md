...
**Future-MITE** 是一款基于 **FishModLoader 3.4.1** 开发的模组，旨在移植高版本的内容到 MITE。它的前身是 BetterMite，现在正式更名为了 Future-MITE。

## 版本要求

- **V1.x**：FML 3.4.1，锈铁核心 1.3.8，waila 2.0.0（非必须，仅用来显示营火的特殊信息）
